...
active_markets_string = '{:,}'.format(active_currencies)
...
print('The global cap of all cryptos is AUD$' + global_cap_string + ' and the 24 hour global volume is ' + global_volume_string + ' units.' )
